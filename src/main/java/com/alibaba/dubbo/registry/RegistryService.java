 ...
 * 
 * @see Registry
 * @see RegistryFactory#getRegistry(com.alibaba.dubbo.common.URL)
...
public interface RegistryService {
     ...
     * @return 已注册信息列表，可能为空，含义同{@link NotifyListener#notify(java.util.List< com.alibaba.dubbo.common.URL>)}的参数。
     */
