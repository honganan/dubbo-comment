...
/**
 * a simple util class for cache {@link com.alibaba.dubbo.config.ReferenceConfig}.
 * <p>
 * {@link com.alibaba.dubbo.config.ReferenceConfig} is a heavy Object, it's necessary to cache these object
 * for the framework which create {@link com.alibaba.dubbo.config.ReferenceConfig} frequently.
 * <p>
 * You can implement and use your own {@link com.alibaba.dubbo.config.ReferenceConfig} cache if you need use complicate strategy.
 *
 * @author ding.lid
 */
public class ReferenceConfigCache {
    ...
    /**
     * Get the cache use specified name and {@link com.alibaba.dubbo.config.utils.ReferenceConfigCache.KeyGenerator}.
     * Create cache if not existed yet.
     */
    ...
    /**
     * Get the cache use specified {@link com.alibaba.dubbo.config.utils.ReferenceConfigCache.KeyGenerator}.
     * Create cache if not existed yet.
     */
    ...
    /**
     * Create the key with the <b>Group</b>, <b>Interface</b> and <b>version</b> attribute of {@link com.alibaba.dubbo.config.ReferenceConfig}.
     * <p>
    ...
    /**
     * clear and destroy one {@link com.alibaba.dubbo.config.ReferenceConfig} in the cache.
    ...
    /**
     * clear and destroy all {@link com.alibaba.dubbo.config.ReferenceConfig} in the cache.
     */
