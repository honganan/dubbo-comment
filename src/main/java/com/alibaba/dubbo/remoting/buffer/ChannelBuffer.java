 ...
 * com.alibaba.dubbo.remoting.buffer.ChannelBuffers} rather than calling an individual implementation's
 * constructor.
 * <p/>
 * <h3>Random Access Indexing</h3>
 * <p/>
 * Just like an ordinary primitive byte array, {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} uses <a
 ...
 * <p/>
 * <pre>
 * {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} buffer = ...;
 ...
 * <p/>
 * {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} provides two pointer variables to support sequential
 ...
 * com.alibaba.dubbo.remoting.buffer.ChannelBuffer} and no destination index is specified, the specified buffer's
 ...
 * If the argument of the write operation is also a {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer}, and
 ...
 * from {@link java.nio.ByteBuffer#clear()}.
 * <p/>
 * <pre>
 *  BEFORE clear()
 *
 ...
 * and reset methods in {@link java.io.InputStream} except that there's no {@code
 * readlimit}.
 * <p/>
 ...
 * <h4>Byte array</h4>
 * <p/>
 * If a {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} is backed by a byte array (i.e. {@code byte[]}),
 ...
 * <h4>NIO Buffers</h4>
 * <p/>
 * Various {@link #toByteBuffer()}  methods convert a {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} into
 ...
 * <h4>I/O Streams</h4>
 * <p/>
 * Please refer to {@link com.alibaba.dubbo.remoting.buffer.ChannelBufferInputStream} and {@link
...
public interface ChannelBuffer extends Comparable<ChannelBuffer> {
     ...
     * not an instance of {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} type.
     */
    public boolean equals(Object o);

    /**
     * Returns the factory which creates a {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} whose type and
     ...
     * com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except that this method increases the {@code
     * writerIndex} of the destination by the number of the transferred bytes
     * while {@link #getBytes(int, com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)} does not. This
     ...
     * {@link #getBytes(int, com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except that this method
     * increases the {@code writerIndex} of the destination by the number of the
     * transferred bytes while {@link #getBytes(int, com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}
     ...
     *                                   length} is greater than {@code
     *                                   this.capacity}
     * @throws java.io.IOException               if the specified stream threw an
     ...
     * #readBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except that this method increases
     * the {@code writerIndex} of the destination by the number of the
     * transferred bytes while {@link #readBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)} does
     * not.
     *
     ...
     * basically same with {@link #readBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except
     ...
     * #readBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)} does not.
     *
     ...
     * while {@link #setBytes(int, com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)} does not. This
     * method does not modify {@code readerIndex} or {@code writerIndex} of the
     * source buffer (i.e. {@code this}).
     *
     * @throws IndexOutOfBoundsException if the specified {@code index} is less
     ...
     * {@link #setBytes(int, com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except that this method
     * increases the {@code readerIndex} of the source buffer by the number of
     * the transferred bytes while {@link #setBytes(int, com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int,
     ...
     * {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} buf = {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffers}.buffer(8);
     *
     ...
     * {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffer} buf = {@link com.alibaba.dubbo.remoting.buffer.ChannelBuffers}.wrappedBuffer(new
     * byte[8]);
     *
     ...
     * #writeBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except that this method increases
     * the {@code readerIndex} of the source buffer by the number of the
     * transferred bytes while {@link #writeBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)} does
     * not.
     *
     ...
     * basically same with {@link #writeBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)}, except
     ...
     * #writeBytes(com.alibaba.dubbo.remoting.buffer.ChannelBuffer, int, int)} does not.
     *
     * @param length the number of bytes to transfer
     *
     * @throws IndexOutOfBoundsException if {@code length} is greater than
